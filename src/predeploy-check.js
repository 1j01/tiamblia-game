...
const predeploy = () => {
	...
	// I could use https://www.npmjs.com/package/npm-link-check
	// but I mainly just want to check skele2d is not linked,
	// and this is just a little bit more general than that.
